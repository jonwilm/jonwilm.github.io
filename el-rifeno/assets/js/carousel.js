(function($) {
  ...
  class Carousel extends Component {
    ...
    constructor(el, options) {
      ...
      // Setup
      this.hasMultipleSlides = this.$el.find('.carousel-material-item').length > 1;
      ...
      this.$el.find('.carousel-material-item').each((el, i) => {
        this.images.push(el);
        if (this.showIndicators) {
    ...
    _handleCarouselClick(e) {
      ...
      if (this.dragged) {
        ...
        let clickedIndex = $(e.target)
          .closest('.carousel-material-item')
          .index();
    ...
    _handleResize(e) {
      if (this.options.fullWidth) {
        this.itemWidth = this.$el
          ...
          .first()
          .innerWidth();
        this.imageHeight = this.$el.find('.carousel-material-item.active').height();
    ...
    _setCarouselHeight(imageOnly) {
      let firstSlide = this.$el.find('.carousel-material-item.active').length
        ? this.$el.find('.carousel-material-item.active').first()
        : this.$el.find('.carousel-material-item').first();
    ...
    _scroll(x) {
      ...
      if (!this.noWrap || (this.center >= 0 && this.center < this.count)) {
        ...
        if (!$(el).hasClass('active')) {
          this.$el.find('.carousel-material-item').removeClass('active');
      ...
      // onCycleTo callback
      let $currItem = this.$el.find('.carousel-material-item').eq(this._wrap(this.center));
